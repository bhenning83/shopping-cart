...
function Home() {
  ...
  return (
    <div className='home'>
      ...
      <div className='bio'>
        Since the days of the railroad, Lincoln, Nebraska has been known for its average coffee. We are here to continue this proud tradition. Every batch of Brandon's Beans is lovingly roasted by our fully automated process using the most economical beans money can buy.<br /><br /> We are Brandon's Coffee Roasters, and we are here to whelm you. 
      </div> 
